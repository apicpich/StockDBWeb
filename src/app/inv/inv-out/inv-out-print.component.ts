      ...
      <tbody><tr><td style="padding: 0">
        <div class="content">
          ...
          <div class="body-row">
            ...
            <div style="width: 25%">{{data.pd_name}}</div>
            ...
            <div style="width: 7%" class="ctx p0">{{data.pd_unit}}</div>
...
export class ProductInvOutPrintComponent implements OnInit {
  ...
  ngOnInit() {
    this.inv.CustName = this.globalService.customerTable.find(x => x.value === this.inv.StInvCust).label;
